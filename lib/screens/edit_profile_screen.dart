                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12),
                              side: BorderSide(color: context.appOutlineVariant),
                            ),
                          ),
                        ),
                      ],
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.calendar_today, color: context.appPrimary),
                const SizedBox(width: 12),
                Text(
                  'Date of Birth',
                  style: AppTheme.bodyMd.copyWith(
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          icon: Icon(Icons.keyboard_arrow_down, color: context.appPrimary),
          isExpanded: true,
          onChanged: (newValue) {
            if (newValue != null) {
              onChanged(newValue);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.straighten, color: context.appPrimary),
              const SizedBox(width: 12),
              Text(
                'Units',
                style: AppTheme.bodyMd.copyWith(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (current == option1) ...[
                        ...
                        Icon(Icons.check, size: 14, color: context.appPrimary),
                      ],
                    ],
                  ),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.card_membership, color: context.appPrimary),
              const SizedBox(width: 12),
              Text(
                'Subscription Plan',
                style: AppTheme.bodyMd.copyWith(
                ...
                child: Row(
                  children: [
                    Icon(
                      Icons.check_circle,
                      size: 14,
                      color: isSelected ? context.appPrimary : context.appOutlineVariant,
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
